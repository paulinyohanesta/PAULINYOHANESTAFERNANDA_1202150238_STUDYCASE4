package com.example.win10.paulinyohanestafernanda_1202150238_studycase4;
...
public class ListMahasiswa extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] namaMahasiswa = {"Paulin", "Kirana", "Juan", "Inocent", "Clara", "Marcus", "Agas",
            "Anno", "Andre", "Jati", "Enny", "Celline", "Cello", "Michael", "Michelle", "Algon", "Agus", "Nita", "Puji", "Yanti"};
